...
export default function Footer() {
  ...
  return (
    <footer className="bg-soft-pink ice-crystal-pattern text-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="text-gray-600 text-base">
              Portfolio-Demonstration einer modernen Eisdiele-Website
            </p>
          </div>
        ...
        <div className="border-t border-rose-200 mt-8 pt-8 text-center">
          <p className="text-gray-600 text-base">
            &copy; 2024 Schleckwerk Manufaktur. Alle Rechte vorbehalten.
          </p>
        </div>
      </div>
    </footer>
