...
export default function Contact() {
  return (
    // **WICHTIG:** Hier ist die ID 'contact' gesetzt, auf die der Intersection Observer wartet.
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Mitten im Herzen von Berlin - täglich frisches Eis für Sie
          </p>
        </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <p className="font-medium text-gray-900">Musterstraße 123</p>
                  <p className="text-gray-600">10115 Berlin Mitte</p>
                  <p className="text-sm text-gray-500 mt-1">5 Min. vom Alexanderplatz</p>
                </div>
              </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-lg">
            ...
            <div className="mt-8 p-4 bg-rose-50 rounded-xl border border-rose-100">
              <p className="text-sm text-rose-700 text-center">
                Bei schönem Wetter haben wir oft länger geöffnet
              </p>
            </div>
