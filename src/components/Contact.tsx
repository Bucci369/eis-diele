            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-lg">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">Alexanderplatz</p> {/* Angepasst an den Karteninhalt */}
                    <p className="text-gray-600">10178 Berlin</p> {/* Typische PLZ für Alex */}
                    <p className="text-sm text-gray-500 mt-1">Direkt im Zentrum</p>
                  </div>
                </div>
                {/* Telefon */}
                <a 
